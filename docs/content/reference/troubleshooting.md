...
Most of these come down to network reality or how ncei serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ncei rate-limits like any public site. ncei already paces
...
Where a surface is gated, ncei reads a cookie or token you supply
...
`ncei`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ncei actually did
